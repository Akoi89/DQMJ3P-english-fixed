...
**Prompts.** Every line's control codes match the Japanese line's. Five yes/no prompts had lost their prompt code, among them the Rank ★★ and ★★★ Speed Road prompts, which closed before you could choose and locked you out of the later races.
